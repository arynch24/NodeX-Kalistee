...
const GsapAnim = () => {
  ...
  return (
    <div className=" space-x-4 flex justify-center items-center flex-wrap  h-[350px] bg-zinc-100 gap-2 text-center">
      {/* Correct image paths using the imports */}
      <span className="image">
        <img src={a1} alt="Image1" className="w-32 h-32 object-cover" />
        <br />
        <p>PURPOSEFUL <br /> ACTIVES</p>
      </span>
      <span className="image">
        <img src={a2} alt="Image2" className="w-32 h-32 object-cover" />
        <br />
        <p>PURPOSEFUL <br /> ACTIVES</p>
      </span>
      <span className="image">
        <img src={a3} alt="Image3" className="w-32 h-32 object-cover" />
        <br />
        <p>PURPOSEFUL <br /> ACTIVES</p>
      </span>
      <span className="image">
        <img src={a4} alt="Image4" className="w-32 h-32 object-cover" />
        <br />
        <p>PURPOSEFUL <br /> ACTIVES</p>
      </span>
      <span className="image">
        <img src={a5} alt="Image5" className="w-32 h-32 object-cover" />
        <br />
        <p>PURPOSEFUL <br /> ACTIVES</p>
      </span>
      <span className="image">
        <img src={a6} alt="Image6" className="w-32 h-32 object-cover" />
        <br />
        <p>PURPOSEFUL <br /> ACTIVES</p>
      </span>
    </div>
